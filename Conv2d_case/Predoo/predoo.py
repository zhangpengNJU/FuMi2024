...
def Max_guided(corpus, f, g , s , s2, c1 ,c2):
    ...
    while not corpus.empty() and j < 20000:
        ...
        maxse, maxe1, maxe2 = getMaxdiff(x, csv_writer, j, con16)
        if maxe1 > maxine1:
            torch.save(x,s)
            torch.save(con16, c1)
            index1 = j
...
def getMaxdiff(x, csv_writer, j, con16=None):
    res = []
    maxe = []
    res.append(j)
    ...
    s = time.time()
    torch_conv_16=con16
    #torch_conv_16 = torch_convWithDiffDype(torch.float16)
    original_weights = torch_conv_16.weight
    original_bias = torch_conv_16.bias
    float32_weights = original_weights.float()
    float32_bias = original_bias.float()
    torch_conv_32 = nn.Conv2d(3, 8, kernel_size=(3, 3), stride=(2, 2)).cuda()
    torch_conv_32.weight = nn.Parameter(float32_weights)
    torch_conv_32.bias = nn.Parameter(float32_bias)
    ...
    out_16_16_1 = torch_conv_16(x_16).float()
    out_16_16_2 = torch_conv_16(x_16).double()
    ...
    out_32_32_1 = torch_conv_32(x_32)
    out_32_32_2 = torch_conv_32(x_32).double()
...
if __name__=='__main__':
    ...
    Max_guided(corpus,"/home/users/pzhang/0528/predoo/conv2dpt/12conv2d.csv","/home/users/pzhang/0528/predoo/conv2dpt/12conv2d_count.csv", '/home/users/pzhang/0528/predoo/conv2dpt/12conv2d.pt','/home/users/pzhang/0528/predoo/conv2dpt/12conv2d2.pt','/home/users/pzhang/0528/predoo/conv2dpt/12conv2dl.pt','/home/users/pzhang/0528/predoo/conv2dpt/12conv2dl2.pt',)
